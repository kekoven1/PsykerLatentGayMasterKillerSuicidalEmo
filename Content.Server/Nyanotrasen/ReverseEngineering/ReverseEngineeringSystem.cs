...
public sealed class ReverseEngineeringSystem : EntitySystem
{
    ...
    private ReverseEngineeringTickResult Roll(ReverseEngineeringMachineComponent component, out int actualRoll)
    {
        ...
        return roll switch
        {
            <= 5 => ReverseEngineeringTickResult.Destruction,
            <= 7 => ReverseEngineeringTickResult.Stagnation,
            <= 10 => ReverseEngineeringTickResult.SuccessMinor,
            <= 13 => ReverseEngineeringTickResult.SuccessAverage,
            <= 16 => ReverseEngineeringTickResult.SuccessMajor,
